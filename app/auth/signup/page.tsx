      ...
      <div className="relative max-w-md w-full space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <div>
            ...
            <h2 className="mt-2 text-xl sm:text-2xl font-semibold text-foreground">Create your account</h2>
          </div>
          <p className="text-muted-foreground text-sm">
            Join thousands browsing smarter
          </p>
        </div>
        ...
        <div className="text-center text-sm">
          ...
          <Link href="/auth/login" className="font-semibold gradient-text hover:underline transition-all">
            Sign in
          </Link>
        </div>
      </div>
